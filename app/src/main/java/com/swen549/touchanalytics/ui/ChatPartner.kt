...
val sampleChatPartners = listOf(
    ChatPartner(1, "Bill Li", "Got the UI working", "10:15 AM", Color(0xFF757575)),
    ChatPartner(2, "Howard Kong", "Database is now working", "9:45 AM", Color(0xFFFBC02D)),
    ChatPartner(3, "Kelvin Ng", "I've updated the ML server.", "Yesterday", Color(0xFFEF5350)),
